    ...
    ui(new Ui::MainWindow)
{
    ...
    actSaveFile = new QAction(QIcon("../Iconos/guardar.svg"),"&Guardar",this);
    ...
    actNewFile = new QAction(QIcon("../Iconos/nuevo.svg"),"&Nuevo",this);
    ...
    actOpenFile = new QAction(QIcon("../Iconos/abrir.svg"),"&Abrir",this);
    ...
    actExportHTML = new QAction(QIcon("../Iconos/exportar_html.svg"),"&Exportar",this);
